...
const PRESET_COMPARISONS = [
  ...
  },
  {
    ...
    description: 'Car vs Metro (10km)',
    activity1: { id: 'car_drive', quantity: 10 },
    activity2: { id: 'metro', quantity: 10 },
  },
  {
    id: 'meal',
    title: 'Lunch decision',
    description: 'Burger vs Veggie',
    activity1: { id: 'beef_burger', quantity: 1 },
    activity2: { id: 'vegetarian_meal', quantity: 1 },
  },
  {
    id: 'evening',
    title: 'Evening activity',
    description: '2hr Streaming vs 10 floors elevator',
    activity1: { id: 'streaming', quantity: 2 },
    activity2: { id: 'elevator', quantity: 10 },
  },
];
